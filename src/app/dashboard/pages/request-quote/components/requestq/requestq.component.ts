...
@Component({
  selector: 'app-requestq',
  templateUrl: './requestq.component.html',
  styleUrls: ['./requestq.component.css']
})
export class RequestqComponent implements OnInit {
  ...
  public onSubmit() {
    ...
    console.log(body, brand, model, name, surname, email, phone, buyType);
    
    // Genera la requisición de la cotización
    this._requestQ.setRequestQuote(body, brand, model, name, surname, email, phone, buyType)
    .subscribe({
  ...
  private execImportantMethods(){
    ...
    this._compraTuAutoService.getBrands(stringModels, stringYears, stringCarrocerias, 100000, 5000000, stringStates, stringTransmissions)
    .subscribe({
    ...
    this._compraTuAutoService.getModels( stringBrands, stringYears, stringCarrocerias, 100000, 5000000, stringStates, stringTransmissions)
    .subscribe({
    ...
    this._compraTuAutoService.getYears( stringBrands, stringModels, stringCarrocerias, 100000, 5000000, stringStates, stringTransmissions )
    .subscribe({
    ...
    // Get vehiclebodies
    this._compraTuAutoService.getVehicleBodies( stringBrands, stringModels, stringYears, 100000, 5000000, stringStates, stringTransmissions )
    .subscribe({
    ...
    this._compraTuAutoService.getStates( stringBrands, stringModels, stringCarrocerias, stringYears, 100000, 5000000, stringTransmissions )
    .subscribe({
    ...
    this._compraTuAutoService.getTransmissions( stringBrands, stringModels, stringCarrocerias, stringYears, 100000, 5000000, stringStates)
    .subscribe({
  ...
  public executeSearch( page: number ) {
    ...
    this._compraTuAutoService.getVehicles( this.pageSize, stringBrands, stringModels, stringYears,
                                          stringCarrocerias, 100000, 5000000, this.palabra_busqueda.length > 0 ? this.palabra_busqueda : 'a',
