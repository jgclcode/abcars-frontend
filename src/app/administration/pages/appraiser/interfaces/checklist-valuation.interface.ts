export interface ChecklistValuation {
    status:           string;
    code:             string;
...
export interface DataChecklist {
    ...
    direct_purchase_take_account: string;
    seller:            string;
    ownedPreowned:     string;
    color:             string;
    cilindres:         string;
    engine_type:       string;
    plates:            string;
    ...
    take:              number;
    sale:              number;
    take_intelimotors: number;
    sale_intelimotors: number;
    workforce:         number;
    spare_parts:       number;
    hyp:               number;
    total:             number;
    ...
    updated_at:        Date;
    user:              User;
    user_technician:   UserTechnician;
}
